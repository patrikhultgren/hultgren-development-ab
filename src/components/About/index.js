      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-lg-9">
            ...
            <p>Jag är en driven frontend utvecklare och är van att hantera projekt från start till mål. Tekniker jag ofta använder är <strong>React</strong> och <strong>Next.js</strong>. Mitt fokus går mot <strong>JavaScript</strong> då det möjligör användarvänliga webbapplikationer.</p>
            <p>Jag har en filosofi kandidatexamen i digital medieteknik som jag läst på Blekinge Tekniska Högskola.</p>
          </div>
        </div>
      </div>
    </article>
